...
<head>
	...
	<title>Tambah Jurusan - SMKN 1 Luwu Utara</title>
					...
					<div class="card-body">
						<form method="POST" action="proses_tambah.php">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="nama_jurusan" placeholder="Jurusan" autocomplete="off" required="required" name="nama_jurusan">
							</div>
							<div class="form-group">
