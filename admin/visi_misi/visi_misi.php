...
<head>
	...
	<title>Visi Misi - SMKN 1 Luwu Utara</title>
					...
					<div class="card-body">
						...
						<form method="POST" action="proses_visi_misi.php">
                            ...
                            <label for="visi">Visi</label>
								<textarea name="visi" id="ckeditor" class="ckeditor form-control"><?= $visi_misi['visi'] ?></textarea>
							</div>
                            <div class="form-group">
                            <label for="misi">Misi</label>
								<textarea name="misi" id="ckeditor" class="ckeditor form-control"><?= $visi_misi['misi'] ?></textarea>
							</div>
							<div class="form-group">
