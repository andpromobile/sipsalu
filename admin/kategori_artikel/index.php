...
<head>
	...
	<title>Data Kategori Artikel - SMKN 1 Luwu Utara</title>
						        ...
						        <?php while($row = mysqli_fetch_assoc($query)) : ?>
									<tr>
										...
										<td>
											...
											<a href="hapus.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin menghapus Kategori Artikel ini?')">Hapus</a>
										</td>
									</tr>
								<?php endwhile; ?>
						    </tbody>
