...
if($_FILES['foto']['error'] == 0){
	if($_FILES['foto']['size'] < 1000000){
		...
		$query = mysqli_query($koneksi, "INSERT INTO tbl_alumni (nama_alumni, angkatan, isi, foto, id_jurusan) VALUES('$nama_alumni', $angkatan, '$isi', '$nama_foto', '$id_jurusan')") or die(mysqli_error($koneksi));
